...
export const monitorKeys = {
  ...
  addPane: character("a", "add pane"),
  closePane: character("x", "close pane"),
  swapLeft: character("<", "swap pane"),
  swapRight: character(">", "swap pane"),
  nextPane: special("Tab", "next pane", (input, key) => Boolean(key.tab && !isShiftTab(input, key))),
  previousPane: special("Shift+Tab", "previous pane", isShiftTab),
